...
class KidsControllerTest < ActionController::TestCase
  ...
  test "should create kid" do
    assert_difference('Kid.count') do
      post :create, kid: { classroom_id: @kid.classroom_id, email: @kid.email, first_name: @kid.first_name, last_name: @kid.last_name, school_id: @kid.school_id, teacher_id: @kid.teacher_id }
    end
  ...
  test "should update kid" do
    patch :update, id: @kid, kid: { classroom_id: @kid.classroom_id, email: @kid.email, first_name: @kid.first_name, last_name: @kid.last_name, school_id: @kid.school_id, teacher_id: @kid.teacher_id }
    assert_redirected_to kid_path(assigns(:kid))
  end
